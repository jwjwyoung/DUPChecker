...
print(max(exception_size), min(exception_size), sum(exception_size) * 1.0/len(exception_size), find_median(exception_size), len([i for i in exception_size if i > 0]), len(exception_size))
